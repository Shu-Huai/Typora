...
![Component Tree](http://public.file.lvshuhuai.cn/images/components.png)
...
![实例的生命周期](http://public.file.lvshuhuai.cn/images/lifecycle.svg)生命周期钩子的 `this` 上下文指向调用它的当前活动实例。
...
![img](http://public.file.lvshuhuai.cn/images/v2-b72736d77cfceecc80a2b1497c649e54_1440w.jpg?source=1940ef5c)
