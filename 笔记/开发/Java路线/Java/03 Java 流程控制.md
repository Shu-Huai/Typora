...
![1661129154598](http://public.file.lvshuhuai.cn/images\1661129154598.png)
...
![1661130193692](http://public.file.lvshuhuai.cn/images\1661130193692.png)

再比如，你在使用微信付钱时，微信内部的程序会先判断你的余额是否足够，如果足够就可以支付成功；如果余额不足，就会提示支付失败。

![1661133550463](http://public.file.lvshuhuai.cn/images\1661133550463.png)

**2. if分支的格式**

接下来，我们来看一看if分支在Java语言中长什么样子呢？在Java中if分支有三种格式。

![1661131177976](http://public.file.lvshuhuai.cn/images\1661131177976.png)
...
![1661131910804](http://public.file.lvshuhuai.cn/images\1661131910804.png)
...
![1661132063147](http://public.file.lvshuhuai.cn/images\1661132063147.png)
...
![1661132132708](http://public.file.lvshuhuai.cn/images\1661132132708.png)
...
![1661132888600](http://public.file.lvshuhuai.cn/images\1661132888600.png)

- 第2个问题：if后面的大括号，如果只有一行代码，大括号可以省略

![1661132851560](http://public.file.lvshuhuai.cn/images\1661132851560.png)
...
![1661133510341](http://public.file.lvshuhuai.cn/images\1661133510341.png)
...
![1661134120042](http://public.file.lvshuhuai.cn/images\1661134120042.png)
...
![1661135813464](http://public.file.lvshuhuai.cn/images\1661135813464.png)
...
![1661136001680](http://public.file.lvshuhuai.cn/images\1661136001680.png)
...
![1661136414587](http://public.file.lvshuhuai.cn/images\1661136414587.png)
...
![1661137599188](http://public.file.lvshuhuai.cn/images\1661137599188.png)

具体执行的每一步可以看下面的图解

![1661138616082](http://public.file.lvshuhuai.cn/images\1661138616082.png)
...
![1661139301013](http://public.file.lvshuhuai.cn/images\1661139301013.png)

再比如：再我们教学管理系统中，有很多班级需要展示在页面上，我们没必要每一个班级都写一份展示数据代码，只需要写一份重复执行就可以了。

![1661139453144](http://public.file.lvshuhuai.cn/images\1661139453144.png)
...
![1661141338265](http://public.file.lvshuhuai.cn/images\1661141338265.png)
...
![1661141996444](http://public.file.lvshuhuai.cn/images\1661141996444.png)

![1661141867092](http://public.file.lvshuhuai.cn/images\1661141867092.png)
...
![1661143715539](http://public.file.lvshuhuai.cn/images\1661143715539.png)

如下图所示：do-while循环的执行流程，是按照①  ②③④   ②③④... 的顺序执行的。

我们会发现，do-while循环的特点是先执行，再判断的。即使条件不成立，也会先执行一次。

![1661143856132](http://public.file.lvshuhuai.cn/images\1661143856132.png)
...
![1661145140910](http://public.file.lvshuhuai.cn/images\1661145140910.png)
...
![1661146324812](http://public.file.lvshuhuai.cn/images\1661146324812.png)

![1661146405314](http://public.file.lvshuhuai.cn/images\1661146405314.png)
...
![1661147570538](http://public.file.lvshuhuai.cn/images\1661147570538.png)
