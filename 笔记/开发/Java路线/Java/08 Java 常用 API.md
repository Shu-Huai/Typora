...
![1662602386634](http://public.file.lvshuhuai.cn/images\1662602386634.png)
...
![1662605214383](http://public.file.lvshuhuai.cn/images\1662605214383.png)

字符串的应用场景是非常多的，可以说是无处不在。

比如，在用户登录时，需要对用户名和密码进行校验，这里的用户名和密码都是String

![1662605347797](http://public.file.lvshuhuai.cn/images\1662605347797.png)

再比如，在和网友聊天时，其实输入的文字就是一个一个字符串

![1662605396550](http://public.file.lvshuhuai.cn/images\1662605396550.png)

再比如，在百度上搜索时，搜素的关键词，也是字符串

![1662605442842](http://public.file.lvshuhuai.cn/images\1662605442842.png)

学习完String类之后，还会学习一个类ArrayList

![1662605519698](http://public.file.lvshuhuai.cn/images\1662605519698.png)

大家知道数组是一个容器，有数组干嘛还要集合呢？ 因为数字的长度是固定的，一旦创建不可改变。

比如数组的长度为3，想要存储第4个元素就存不进去了。

![1662605575865](http://public.file.lvshuhuai.cn/images\1662605575865.png)
...
![1662605881879](http://public.file.lvshuhuai.cn/images\1662605881879.png)
...
![1662607669465](http://public.file.lvshuhuai.cn/images\1662607669465.png)
...
![1662607801186](http://public.file.lvshuhuai.cn/images\1662607801186.png)
...
![1662608166502](http://public.file.lvshuhuai.cn/images\1662608166502.png)
...
![1662609378727](http://public.file.lvshuhuai.cn/images\1662609378727.png)
...
![1662610060051](http://public.file.lvshuhuai.cn/images\1662610060051.png)

- **注意事项1：String类的对象是不可变的对象**

我们先看一段代码，分析这段代码的结果

![1662610347618](http://public.file.lvshuhuai.cn/images\1662610347618.png)

以上代码中，先定义了一个String变量 name第一次赋值为`“黑马”;` 然后对`name`变量记录的字符串进行两次拼接，第一次拼接`“程序员”`，第二次拼接`“播妞”`；我们发现得到的结果是：`黑马程序员播妞`

这里问题就来了，你不是是说：**String类的对象是不可变的字符串对象吗？**我看name的值变了呀！！！![1662610591674](http://public.file.lvshuhuai.cn/images\1662610591674.png)
...
![1662610697641](http://public.file.lvshuhuai.cn/images\1662610697641.png)

当执行第二句话时，又会再堆内存的常量池中创建一个字符串`“程序员”`，和`“黑马”`拼接，拼接之后还会产生一个新的字符串对象`”黑马程序员“`，然后将新产生的`“黑马程序员”`对象的地址赋值给`String name`变量。

![1662610978351](http://public.file.lvshuhuai.cn/images\1662610978351.png)
...
![1662618688215](http://public.file.lvshuhuai.cn/images\1662618688215.png)

![1662618651517](http://public.file.lvshuhuai.cn/images\1662618651517.png)
...
![1662618819077](http://public.file.lvshuhuai.cn/images\1662618819077.png)
...
![1662619371060](http://public.file.lvshuhuai.cn/images\1662619371060.png)
...
![1662620084702](http://public.file.lvshuhuai.cn/images\1662620084702.png)

集合该怎么学呢？1. 首先你要会创建集合对象，2. 然后能够调用集合提供的方法对容器中的数据进行增删改查，3. 最后知道集合的一些特点就可以了。

![1662620152564](http://public.file.lvshuhuai.cn/images\1662620152564.png)
...
![1662620389155](http://public.file.lvshuhuai.cn/images\1662620389155.png)
...
![1662620686208](http://public.file.lvshuhuai.cn/images\1662620686208.png)
...
![1662621705234](http://public.file.lvshuhuai.cn/images\1662621705234.png)
...
![1662622656784](http://public.file.lvshuhuai.cn/images\1662622656784.png)
...
![1662623052476](http://public.file.lvshuhuai.cn/images\1662623052476.png)

![1662623321970](http://public.file.lvshuhuai.cn/images\1662623321970.png)

![1662623468659](http://public.file.lvshuhuai.cn/images\1662623468659.png)

![1662623624269](http://public.file.lvshuhuai.cn/images\1662623624269.png)
...
![1662623794937](http://public.file.lvshuhuai.cn/images\1662623794937.png)
...
![1662624841469](http://public.file.lvshuhuai.cn/images\1662624841469.png)
