...
![1661321640902](http://public.file.lvshuhuai.cn/images\1661321640902.png)

如果用变量来做的话，代码是这样子的

![1661321680612](http://public.file.lvshuhuai.cn/images\1661321680612.png)

如果用数组来做的话，代码是这样子的

![1661321716135](http://public.file.lvshuhuai.cn/images\1661321716135.png)
...
![1661353166416](http://public.file.lvshuhuai.cn/images\1661353166416.png)
...
![1661354056668](http://public.file.lvshuhuai.cn/images\1661354056668.png)
...
![1661356063895](http://public.file.lvshuhuai.cn/images\1661356063895.png)

**注意：**

使用动态初始化定义数组时，根据元素类型不同，默认值也有所不同。

![1661417981361](http://public.file.lvshuhuai.cn/images\1661417981361.png)
...
![1661437717797](http://public.file.lvshuhuai.cn/images\1661437717797.png)
...
![1661438278304](http://public.file.lvshuhuai.cn/images\1661438278304.png)
...
![1661439843879](http://public.file.lvshuhuai.cn/images\1661439843879.png)

刚执行完`int[] arr1 = {11,22,33};`时，内存原理如下

![1661439986204](http://public.file.lvshuhuai.cn/images\1661439986204.png)

当执行完`int[] arr2 = arr1;`后，内存原理如下

![1661440179341](http://public.file.lvshuhuai.cn/images\1661440179341.png)

当执行到`arr2[1]=99;时`，内存原理如下

![1661440425901](http://public.file.lvshuhuai.cn/images\1661440425901.png)
...
![1661441712915](http://public.file.lvshuhuai.cn/images\1661441712915.png)
...
![1661442733592](http://public.file.lvshuhuai.cn/images\1661442733592.png)

![1661442758553](http://public.file.lvshuhuai.cn/images\1661442758553.png)

数组中元素交换，就是用的借用第三方变量的思想。 我们把数组中的每一个元素当做一个水杯，然后索引控制哪两个元素互换位置。

怎么样，才能达到元素反转的效果呢？我们只需将第一个和最后一个元素互换、第二个和倒数第二个互换、依次内推.... 如下图所示

![1661443189060](http://public.file.lvshuhuai.cn/images\1661443189060.png)
...
![1661444407716](http://public.file.lvshuhuai.cn/images\1661444407716.png)
...
![1661444896100](http://public.file.lvshuhuai.cn/images\1661444896100.png)
